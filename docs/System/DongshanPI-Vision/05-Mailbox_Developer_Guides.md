...
![frame](http://photos.100ask.net/canaan-docs/130101_frame_00.svg)
...
![data_structure](http://photos.100ask.net/canaan-docs/130102_data_structure.svg)
...
![frame_callback](http://photos.100ask.net/canaan-docs/130103_frame_callback.svg)
...
![add_to_rbuf](http://photos.100ask.net/canaan-docs/130203_add_to_rbuf.svg)
...
![msg_submit](http://photos.100ask.net/canaan-docs/130203_msg_submit.svg)
...
![mbox_send_message](http://photos.100ask.net/canaan-docs/130203_mbox_send_message.svg)
...
![mbox_request_channel](http://photos.100ask.net/canaan-docs/130203_mbox_request_channel.svg)
...
![dsp_load](http://photos.100ask.net/canaan-docs/130601_dsp_load.png)  
2. 运行 Linux 用户空间的测试 app
进入目录`/app/mailbox_demo`，执行命令`./mailbox_async`，如下图所示：  
![mailbox_demo](http://photos.100ask.net/canaan-docs/130602_mailbox_async.png)  
此 demo 使用异步通知的方式接收 dsp 发送来的数据。
3. 在目录`/app/mailbox_demo`中，执行命令`./mailbox_poll`，如下图所示：  
![mailbox_demo](http://photos.100ask.net/canaan-docs/130602_mailbox_poll.png)
