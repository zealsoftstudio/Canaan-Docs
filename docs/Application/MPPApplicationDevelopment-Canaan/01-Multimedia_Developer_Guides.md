...
K510的硬件框图如下：
![hardware_block_diagram](http://photos.100ask.net/canaan-docs/hardware_block_diagram.png)
...
![multimedia_block_diagram.png](http://photos.100ask.net/canaan-docs/multimedia_block_diagram.png)
...
![ffmpeg_block_diagram](http://photos.100ask.net/canaan-docs/ffmpeg_block_diagram.png)

audio3a用于将接收到的音频进行3a运算并输出，其逻辑框图如下：

![ffmpeg_canaan_audio3a](http://photos.100ask.net/canaan-docs/ffmpeg_canaan_audio3a.png)
...
![image-20220721162011470](http://photos.100ask.net/canaan-docs/sdp.png)
...
![image-20220721113937361](http://photos.100ask.net/canaan-docs/EasyDarwin_run.png)
